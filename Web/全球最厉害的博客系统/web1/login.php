...
if($is_forbidden){
    echo "<script>alert('你的IP已经被封禁了，联系管理员去吧~')</script>";
}
if($is_pass_wrong){
        ...
        <div class="container-lg p-responsive position-relative">
            ...
            <div class="d-md-flex flex-items-center gut-lg">
                ...
                <div class="mx-auto col-sm-8 col-md-5 hide-sm rounded-1 bg-gray-light pt-4 pb-5">
                    ...
                    <form accept-charset="GB2312" action="./login.php" class="home-hero-signup" autocomplete="off" method="post">
                        ...
                        <label class="form-label text-gray f5" style="margin-top: 15px;">No account? <a href="./register.php">Sign in now!</a></label>
