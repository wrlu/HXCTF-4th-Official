...
path = '/Users/xiaolulwr/Downloads/'

def get_public_key():
    certificate_file = open(path+'server.crt','rb')
...
def get_private_key():
    private_key_file = open(path+'server.key','rb')
...
if __name__ == '__main__':
    ...
    if check_sign(code, signature, public_key)==True:
        ...
        print('0ops, we cannot run your shell code.')
